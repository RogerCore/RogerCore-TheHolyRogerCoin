...
# Pick some path to install BDB to, here we create a directory within the TheHolyRogerCoin directory
...
# Configure TheHolyRoger Core to use our own-built instance of BDB
cd $THEHOLYROGER_ROOT
./autogen.sh
